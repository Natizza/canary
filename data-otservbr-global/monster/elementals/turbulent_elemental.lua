...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -800, maxDamage = -950, range = 7, shootEffect = CONST_ANI_SNOWBALL, effect = CONST_ME_ICEATTACK, target = true },
	...
	{ name = "combat", interval = 4000, chance = 24, type = COMBAT_ICEDAMAGE, minDamage = -750, maxDamage = -1060, radius = 4, effect = CONST_ME_ICETORNADO, target = false },
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_ICEDAMAGE, minDamage = -850, maxDamage = -1060, radius = 4, effect = CONST_ME_ICEATTACK, target = false },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -650, maxDamage = -1010, length = 5, radius = 2, effect = CONST_ME_GREEN_RINGS, target = false },
	{ name = "soulwars fear", interval = 8000, chance = 1, target = true },
}
