...
monster.attacks = {
	{ name = "melee", interval = 2500, chance = 100, minDamage = -500, maxDamage = -800 },
	{ name = "combat", interval = 2500, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -750, maxDamage = -1030, radius = 4, effect = CONST_ME_GREEN_RINGS, target = false },
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -750, maxDamage = -1050, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYDAMAGE, target = true },
	{ name = "combat", interval = 2500, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -750, maxDamage = -1050, radius = 4, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYDAMAGE, target = true },
	{ name = "extended holy chain", interval = 2000, chance = 15, minDamage = -700, maxDamage = -950, range = 7 },
	{ name = "poison chain", interval = 2000, chance = 15, minDamage = -700, maxDamage = -900, range = 7 },
}
