...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -150, maxDamage = -1100, range = 7, radius = 3, shootEffect = CONST_ANI_POISONARROW, effect = CONST_ME_GREEN_RINGS, target = true },
	{ name = "combat", interval = 2500, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -700, maxDamage = -1010, length = 6, spread = 4, effect = CONST_ME_GREEN_RINGS, target = false },
	...
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -750, maxDamage = -1020, range = 7, radius = 4, effect = CONST_ME_ICEATTACK, target = true },
