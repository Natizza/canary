...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -900, maxDamage = -1050, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYAREA, target = true },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -900, maxDamage = -1050, radius = 5, effect = CONST_ME_BIGPLANTS, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -900, maxDamage = -1050, radius = 7, effect = CONST_ME_BIGPLANTS, target = false },
	{ name = "poison chain", interval = 2000, chance = 20, minDamage = -800, maxDamage = -980, radius = 7, effect = CONST_ME_BIGPLANTS, target = false },
