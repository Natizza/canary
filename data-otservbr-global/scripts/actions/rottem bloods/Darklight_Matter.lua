...
monster.loot = {
	{ name = "crystal coin", chance = 8632, maxCount = 1 },
	{ name = "unstable darklight matter", chance = 5058, maxCount = 1 },
	{ name = "darklight core", chance = 14447, maxCount = 1 },
	{ name = "ultimate health potion", chance = 11340, maxCount = 6 },
	{ id = 3039, chance = 7479, maxCount = 1 }, -- red gem
	{ name = "darklight matter", chance = 6102, maxCount = 1 },
	{ name = "rubber cap", chance = 9445, maxCount = 1 },
	{ id = 23544, chance = 7480, maxCount = 1 }, -- collar of red plasma
	{ name = "green gem", chance = 13982, maxCount = 1 },
	{ name = "shadow sceptre", chance = 12926, maxCount = 1 },
}
...
monster.attacks = {
	...
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -400, maxDamage = -1350, radius = 4, effect = CONST_ME_ENERGYHIT, target = false},
