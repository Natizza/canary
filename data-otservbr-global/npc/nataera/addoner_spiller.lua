...
addoninfo = {
['first citizen addon'] = {cost = 0, items = {{5878,50}}, outfit_female = 136, outfit_male = 128, addon = 1, storageID = Storage.OutfitQuest.Citizen.AddonBackpack},
['second citizen addon'] = {cost = 0, items = {{5890,25}, {5902,15}, {3374,1}}, outfit_female = 136, outfit_male = 128, addon = 2, storageID = Storage.OutfitQuest.Citizen.AddonHat},
['first hunter addon'] = {cost = 0, items = {{5876,50}, {5948,50}, {5891,5}, {5887,1}, {5889,1}, {5888,1}}, outfit_female = 137, outfit_male = 129, addon = 1, storageID = Storage.OutfitQuest.Hunter.AddonHat},
...
['first knight addon'] = {cost = 0, items = {{5880,50}, {5892,1}}, outfit_female = 139, outfit_male = 131, addon = 1, storageID = Storage.OutfitQuest.Knight.AddonSword},
['second knight addon'] = {cost = 0, items = {{5893,50}, {5924,1}, {5885,1}, {5887,1}}, outfit_female = 139, outfit_male = 131, addon = 2, storageID = Storage.OutfitQuest.Knight.AddonHelmet},
['first mage addon'] = {cost = 0, items = {{3074,1}, {3075,1}, {3072,1}, {3073,1}, {3071,1}, {3066,1}, {3070,1}, {3069,1}, {3065,1}, {3067,1}, {5904,5}, {3077,10}, {5809,1}}, outfit_female = 141, outfit_male = 130, addon = 1, storageID = Storage.OutfitQuest.MageSummoner.AddonWand},
['second mage addon'] = {cost = 0, items = {{5903,1}}, outfit_female = 141, outfit_male = 130, addon = 2, storageID = Storage.OutfitQuest.MageSummoner.AddonHatCloak},
['first summoner addon'] = {cost = 0, items = {{5958,1}}, outfit_female = 138, outfit_male = 133, addon = 1, storageID = Storage.OutfitQuest.MageSummoner.AddonBelt},
['second summoner addon'] = {cost = 0, items = {{5894,40}, {5911,10}, {5883,20}, {5922,15}, {5886,5}, {5881,30}, {5882,20}, {5904,5}, {5905,15}}, outfit_female = 138, outfit_male = 133, addon = 2, storageID = Storage.OutfitQuest.MageSummoner.AddonWandTimer},
...
['second barbarian addon'] = {cost = 0, items = {{5884,1}, {5885,1}, {5910,50}, {5911,50}, {5886,5}}, outfit_female = 147, outfit_male = 143, addon = 2, storageID = 51033},
...
['second druid addon'] = {cost = 0, items = {{5906,50}}, outfit_female = 148, outfit_male = 144, addon = 2, storageID = Storage.OutfitQuest.DruidBodyAddon},
...
['second oriental addon'] = {cost = 0, items = {{5883,50}, {5895,50}, {5891,2}, {5912,50}}, outfit_female = 150, outfit_male = 146, addon = 2, storageID = Storage.OutfitQuest.SecondOrientalAddon},
['first warrior addon'] = {cost = 0, items = {{5925,50}, {5899,50}, {5884,1}, {5919,1}}, outfit_female = 142, outfit_male = 134, addon = 1, storageID = Storage.OutfitQuest.WarriorShoulderAddon},
['second warrior addon'] = {cost = 0, items = {{5880,50}, {5887,1}}, outfit_female = 142, outfit_male = 134, addon = 2, storageID = Storage.OutfitQuest.WarriorSwordAddon},
['first wizard addon'] = {cost = 0, items = {{5922,25}}, outfit_female = 149, outfit_male = 145, addon = 1, storageID = 51034},
['second wizard addon'] = {cost = 0, items = {{3436,1}, {3386,1}, {3382,1}, {3006,1}}, outfit_female = 149, outfit_male = 145, addon = 2, storageID = 51035},
['first assassin addon'] = {cost = 0, items = {{5912,25}, {5910,25}, {5911,25}, {5913,25}, {5914,25}, {5909,25}, {5886,5}}, outfit_female = 156, outfit_male = 152, addon = 1, storageID = Storage.OutfitQuest.AssassinFirstAddon},
...
['first beggar addon'] = {cost = 0, items = {{5878,25}, {5921,15}, {5913,10}, {5894,5}, {5883,50}}, outfit_female = 157, outfit_male = 153, addon = 1, storageID = Storage.OutfitQuest.BeggarFirstAddonDoor},
...
['first pirate addon'] = {cost = 0, items = {{6098,50}, {6126,50}, {6097,50}}, outfit_female = 155, outfit_male = 151, addon = 1, storageID = Storage.OutfitQuest.PirateSabreAddon},
...
['second norseman addon'] = {cost = 0, items = {{7290,5}}, outfit_female = 252, outfit_male = 251, addon = 2, storageID = 51039}
}
