...
GameStore.Categories = {
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs", "Potions", "Buff Potions", "Runes" },
	},
		...
		offers = {
			{
				...
				itemtype = 36723,
				count = 1,
				description = "<i>Reset your all cooldowns and you can use that one time for 1 hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},

			{
				...
				itemtype = 36724,
				count = 1,
				description = "<i>Increase 5% of your critical chance for 1 hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},

			{
				...
				itemtype = 36726,
				count = 1,
				description = "<i>Increase your chance of rune attacks in 5% for 1 hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},

			{
				...
				itemtype = 36725,
				count = 1,
				description = "<i>Regenerate your stamina 1 hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},

			{
				...
				itemtype = 36727,
				count = 1,
				description = "<i>Drinking this potion temporarily doubles the loot from every regular monster you kill.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},

			{
				...
				itemtype = 36728,
				count = 1,
				description = "<i>Doubles your bestiary kills for 1 hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},

			{
				...
				itemtype = 36729,
				count = 1,
				description = "<i>Drinking this potion temporarily increases fire protection",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
{
				icons = { "" },
				...
				itemtype = 36730,
				count = 1,
				description = "<i>Drinking this potion temporarily increases ice protection",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
{
				icons = { "" },
				...
				itemtype = 36731,
				count = 1,
				description = "<i>Drinking this potion temporarily increases eath protection",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
{
				icons = { "" },
				...
				itemtype = 36732,
				count = 1,
				description = "<i>Drinking this potion temporarily increases energy protection",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
{
				icons = { "" },
				...
				itemtype = 36733,
				count = 1,
				description = "<i>Drinking this potion temporarily increases holy protection",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
{
				icons = { "" },
				...
				itemtype = 36734,
				count = 1,
				description = "<i>Drinking this potion temporarily increases death protection",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
{
				icons = { "" },
				...
				itemtype = 36735,
				count = 1,
				description = "<i>Drinking this potion temporarily increases physical protection",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
{
				icons = { "" },
				...
				itemtype = 36736,
				count = 1,
				description = "<i>Drinking this potion temporarily amplifies fire damage against monsters",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "" },
				...
				itemtype = 36737,
				count = 1,
				description = "<i>Drinking this potion temporarily amplifies ice damage against monsters",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "" },
				...
				itemtype = 36738,
				count = 1,
				description = "<i>Drinking this potion temporarily amplifies earth damage against monsters",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "" },
				...
				itemtype = 36739,
				count = 1,
				description = "<i>Drinking this potion temporarily amplifies energy damage against monsters",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "" },
				...
				itemtype = 36740,
				count = 1,
				description = "<i>Drinking this potion temporarily amplifies holy damage against monsters",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
						{
				icons = { "" },
				...
				itemtype = 36741,
				count = 1,
				description = "<i>Drinking this potion temporarily amplifies physical damage against monsters",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},			
		},
	},
	...
	-- custom
--			{
--				icons = { "Outfit_Golden_Outfit_Male.png", "Outfit_Golden_Outfit_Female.png" },
--				name = "Golden Outfit",
--				price = 5000,
--				sexId = { female = 1210, male = 1211 },
--				addon = 3,
--				description = "{character}\n{info} Made of ancient thaian gold, you'll look shiny wearing this masterpiece. </i>",
--				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
--			},
			{
				icons = { "Outfit_Royal_Costume_Male.png", "Outfit_Royal_Costume_Female.png"},
				name = "Royal Costume",
				price = 1500,
	...
	-- House
	{
		...
		name = "Houses",
		rookgaard = true,
		subclasses = { "Decorations", "Furniture", "Furniture 2", "Upgrades", "Hirelings", "Hirelings Dresses" },
	},
	-- House ~ Decorations
	{
	...
	
{
	...
	-- House ~ Upgrades
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 28561,
				count = 1,
				description = "<i>Train your skills 15% more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
...

	{
		...
		name = "Items",
		rookgaard = true,
		subclasses = { "Tools", "Extra items", "Backpack" },
	},
	-- Items ~ Extras
	{
		icons = { "Category_ExclusiveOffers.png" },
		...
		offers = {
			 {
				icons = { "" },
				name = "Permanent Teleport",
				price = 500,
				itemtype = 31633,
				count = 1,
				description = "<i>This will teleport you to your house, any city, and many bosses with a 2 minute cooldown.",
			...
			},
			{
				...
				itemtype = 28484,
				count = 1,
				description = "<i>Blueberry Cupckake.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true
			},			
			{
...

			{
				...
				itemtype = 28485,
				count = 1,
				description = "<i>Strawberry Cupckake.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true
			},
			{
			...
			},
			{
				...
				itemtype = 18339,
				count = 1,
				description = "<i>You see a Zaoan chess box (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
	},
	...
	-- Extras ~ Extras Services
	{
		...
		offers = {
			{	
				...
				itemtype = 44813,
				count = 1,
				description = "<i>Train your skills 20% more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{	
				icons = { "arcangel_exercise_dummy" },
				name = "Arcangel Exercise Dummy",
				price = 700,
				itemtype = 44789,
				count = 1,
				description = "<i>Train your skills 20% more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
					...
					{
				icons = { "undead_exercise_dummy" },
				name = "Undead Exercise Dummy",
				price = 700,
				itemtype = 44787,
				count = 1,
				description = "<i>Train your skills 20% more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
		...
		offers = {
			{
				...
				itemtype = 9594,
				count = 1,
				description = "<i>sneaky stabber of eliteness.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
				{
				...
				itemtype = 9596,
				count = 1,
				description = "<i>squeezing gear of girlpower.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
		{
				...
				itemtype = 9598,
				count = 1,
				description = "<i>whacking driller of fate.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
		...
		offers = {
			{
				...
				itemtype = 44812,
				count = 1,
				description = "<i>christmas backpack (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
						{
				icons = { "" },
				name = "Nataera backpack",
				price = 200,
				itemtype = 37536,
				count = 1,
				description = "<i>nataera backpack (Vol:100).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
				movable = true
			},
				...
				itemtype = 44802,
				count = 1,
				description = "<i>Halloween backpack (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
									{
				...
				itemtype = 44784,
				count = 1,
				description = "<i>Mayimbu Backpack (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
						{
				icons = { "" },
				name = "Suddendeath Backpack",
				price = 100,
				itemtype = 44785,
				count = 1,
				description = "<i>Suddendeath Backpack (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
						{
				icons = { "" },
				name = "Esferaball Backpack",
				price = 100,
				itemtype = 44781,
				count = 1,
				description = "<i>esferaball backpack (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
									{
				...
				itemtype = 44782,
				count = 1,
				description = "<i>Dragon Backpack (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
												{
				...
				itemtype = 44780,
				count = 1,
				description = "<i>Pikachu Backpack (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true
			},
		},
	...
	-- Tournament
	{
		...
		name = "Tournament",
		rookgaard = true,
		subclasses = { "Extra Tournament", "Exercise", "Free Outfits", "Free Mounts"},
		},
	{
		icons = { "Category_Tournament.png" },
		name = "Extra Tournament",
		parent = "Tournament",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			...
			},
			{
				...
				name = "Prey Wildcard",
				price = 800,
				id = GameStore.SubActions.PREY_WILDCARDTOURNAMENT,
				count = 10,
				description = "<i>Use Prey Wildcards to reroll the bonus of an active prey, to lock your active prey or to select a prey of your choice.</i>\n\n{character}\n{info} added directly to Prey dialog\n{info} maximum amount that can be owned by character: 50",
				coinType = 0,
				type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUSTOURNAMENT,
			},
			{
							icons = { "" },
				name = "sneaky stabber of eliteness",
		...
		offers = 
			{
				...
				count = 1,
				charges = 40000,
				description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 40000 times a piece\n{info} usable 20000 times a piece",
				coinType = 0,
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
